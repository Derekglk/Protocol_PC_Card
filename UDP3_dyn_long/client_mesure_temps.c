...
void *t_rec (void * buff){
	...
	long clk_tck2 = CLOCKS_PER_SEC; // Fréquence de l'horloge 
	clock_t t12, t22; // Tics d'horloge écoulés depuis le début de l'exécution
	...
	/*Affichage du temps écoulé pour l'envoi*/
    printf("Reception : Nb ticks/seconde = %ld,  Nb ticks écoulés %ld\n",clk_tck2, (long)(t22-t12));
    printf("Reception : Temps consomme (ms) : %lf \n",(double)(t22-t12)*1000/(double)clk_tck2);
